...
import com.example.crawling.item.api.dto.IngredientResponseDto;
import com.example.crawling.item.domain.cosmetic.ingredient.*;
import com.example.crawling.item.domain.vo.IngredientVO;
